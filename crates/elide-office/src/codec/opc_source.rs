...
use elide_codec::extract::ItemEdit;
use elide_core::modality::text::SourceRef;

use crate::opc::OffsetMap;
...
pub(super) fn source_span(part: &str, offsets: &OffsetMap, local: Range<usize>) -> Vec<SourceRef> {
    offsets
        .raw_ranges(local)
        .into_iter()
