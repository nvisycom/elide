...
//! [`CellEdit`](crate::xlsx::CellEdit)s and the workbook is re-packed
//! byte-faithfully by this crate, de-sharing any shared-string cell that
...
pub(crate) struct XlsxHandler {
    /// The original package bytes, retained so this crate re-packs every
