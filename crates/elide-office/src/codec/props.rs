...
/// Stable [`FormatId`](elide_codec::FormatId) for an OOXML property sub-part.
pub const FORMAT_ID: elide_codec::FormatId = elide_codec::FormatId::new("elide.office.docprops");
